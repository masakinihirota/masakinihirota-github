...
IMPORTANT: このプロンプトは `implementation_plan.md` および `mvp_tasks.md` に記載された要件に基づき、TDD サイクルを通じてコードを実装することを目的としています。
...
1.  **要件特定**: `implementation_plan.md` / `mvp_tasks.md` を読み、次に実装すべき「最小の機能単位」を特定する。
