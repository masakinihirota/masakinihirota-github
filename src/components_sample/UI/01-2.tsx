...
import {
  ...
  MessageSquare, Heart, Search, Star, CheckCircle, Bell
} from 'lucide-react';
...
const LandingPage = () => {
  ...
  const Button = ({ children, variant = 'primary', className = '', ...props }) => {
    ...
    const variants = {
      ...
      // Outline: 青枠線
      outline: "bg-transparent border-2 border-[#007EFE] text-[#007EFE] hover:bg-[#007EFE] hover:text-white",
      // Text: テキストリンク
    ...
    <div className="min-h-screen bg-[#F5FAFD] font-sans text-slate-800">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex justify-between items-center">
          ...
          >
            <div className={`w-8 h-8 rounded-lg flex items-center justify-center font-bold text-lg transition-colors ${scrolled ? 'bg-[#007EFE] text-white' : 'bg-white text-[#007EFE]'}`}>
              V
            </div>
        ...
        {isMenuOpen && (
          <div className="fixed inset-0 bg-[#007EFE]/95 backdrop-blur-lg z-40 flex flex-col items-center justify-center gap-8 md:hidden">
            ...
            <Button variant="white" className="w-64" onClick={() => window.location.href = '/signup'}>
              会員登録
            </Button>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#007EFE]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center flex flex-col items-center gap-8 pt-20">
          ...
          <div className="flex flex-col items-center gap-2 mt-4 text-[#E6F4FB] animate-fade-in-up delay-100">
            ...
            <span className="text-sm bg-white/10 px-3 py-1 rounded-full border border-white/20">VNS Concept</span>
          </div>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-[#007EFE] font-bold tracking-wider uppercase text-sm">Features</span>
      ...
      <section className="py-20 px-4 bg-[#F5FAFD] border-y border-[#E6F4FB]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-slate-800">登録したら何ができるの？</h2>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-12">
            ...
            <div className="flex flex-col items-center max-w-xs relative">
              ...
              <div className="absolute top-0 left-0 bg-[#007EFE] text-white w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold">1</div>
            ...
            <div className="flex flex-col items-center max-w-xs relative">
              ...
              <div className="absolute top-0 left-0 bg-[#00C48C] text-white w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold">2</div>
              <h4 className="font-bold text-lg mb-2">AIマッチング</h4>
              <p className="text-sm text-slate-500">価値観の合う仲間や、運命の作品が推薦されます。</p>
            </div>
            ...
            <div className="flex flex-col items-center max-w-xs relative">
              ...
              <div className="absolute top-0 left-0 bg-[#FFD600] text-white w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold">3</div>
      ...
      <section className="py-16 px-4 bg-[#007EFE] text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-[#E6F4FB] mb-8">
            メールアドレス不要。ワンクリックで体験ツアーに参加できます。<br />
            気に入ったら、後から本登録も可能です。
          </p>
      ...
      <section className="py-20 px-4 bg-[#F5FAFD]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              // 1. 青
              { icon: User, title: "詳細プロフィール", desc: "100以上の質問で、あなたの価値観をAIが分析・言語化します。", color: "text-[#007EFE]" },
              // 2. 緑（サブカラー）
              { icon: Search, title: "作品検索・推薦", desc: "Amazon等のデータベースから、あなたに響く作品を探せます。", color: "text-[#00C48C]" },
              // 3. 黄色（アクセント）
              { icon: Users, title: "相性マッチング", desc: "表面的な趣味だけでなく、深層心理での相性を可視化します。", color: "text-[#FFD600]" },
              // 4. 青
              { icon: MessageSquare, title: "1on1チャット", desc: "安心して話せる相手と、深い対話を楽しむことができます。", color: "text-[#007EFE]" },
              // 5. 緑（サブカラー）
              { icon: PartyPopper, title: "コミュニティ", desc: "共通のテーマで集まり、イベントや議論を開催できます。", color: "text-[#00C48C]" },
              // 6. 黄色（アクセント）
              { icon: Shield, title: "匿名性の保護", desc: "複数の「仮面（ペルソナ）」を使い分け、TPOに合わせた自分で参加。", color: "text-[#FFD600]" },
              // 7. 青
              { icon: Heart, title: "感謝を送る", desc: "いいねの代わりに「感謝」や「共感」を送る温かいシステム。", color: "text-[#007EFE]" },
              // 8. 緑（サブカラー）
              { icon: CheckCircle, title: "オアシス宣言", desc: "攻撃的な言動から守られた、心理的安全性の高い空間。", color: "text-[#00C48C]" }
            ].map((feature, idx) => (
              <div key={idx} className="flex flex-col items-start p-6 rounded-xl bg-white hover:bg-white hover:shadow-lg transition-all duration-300 border border-[#E6F4FB]">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-4 text-slate-800 font-bold text-lg">
              <div className="w-6 h-6 bg-[#007EFE] text-white rounded flex items-center justify-center text-xs">V</div>
              masakinihirota
            </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/oasis-declaration" className="hover:text-[#007EFE] transition-colors">オアシス宣言</a></li>
              <li><a href="/human-declaration" className="hover:text-[#007EFE] transition-colors">人間宣言</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/report" className="hover:text-[#007EFE] transition-colors">お問い合わせ</a></li>
              <li><a href="/help" className="hover:text-[#007EFE] transition-colors">ヘルプセンター</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/terms-of-service" className="hover:text-[#007EFE] transition-colors">利用規約</a></li>
              <li><a href="/privacy-policy" className="hover:text-[#007EFE] transition-colors">プライバシーポリシー</a></li>
            </ul>
          </div>
        </div>
