...
import { Home, Users, User, Building2, Globe, BookOpen, Heart, Zap, Link as LinkIcon, Grid, Settings, Shield, Search, FileText } from 'lucide-react';
...
const menuItems = [
    ...
    { label: 'オアシス宣言', href: '/playground/oasis-demo', icon: FileText, active: true },
];
