...
import { Home, Users, User, Building2, Globe, BookOpen, Heart, Zap, Link as LinkIcon, Grid, Settings, Shield, Search, FileText, Scale, Lock } from 'lucide-react';
...
const menuItems = [
    ...
    { label: '組織', href: '/playground/organization-list-demo', icon: Building2 },
    { label: '国（ネイション）', href: '/playground/nation-list-demo', icon: Globe },
    { label: '作品', href: '/playground/works-demo', icon: BookOpen },
    ...
    { label: '設定', href: '/playground/settings-demo', icon: Settings },
    { label: 'ルートアカウント', href: '/playground/root-account-demo', icon: Shield },
    { label: '検索', href: '/playground/search-demo', icon: Search },
    { label: 'オアシス宣言', href: '/playground/oasis-demo', icon: FileText },
    { label: '利用規約', href: '/playground/terms-demo', icon: Scale },
    { label: 'プライバシーポリシー', href: '/playground/privacy-demo', icon: Lock, active: true },
];
