...
import { Home, Users, User, Building2, Globe, BookOpen, Heart, Zap, Link as LinkIcon, Grid, Settings, Shield, Search, FileText, Scale } from 'lucide-react';
...
const menuItems = [
    ...
    { label: '利用規約', href: '/playground/terms-demo', icon: Scale, active: true },
];
