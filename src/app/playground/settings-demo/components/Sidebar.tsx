...
import { Home, Users, User, Building2, Globe, BookOpen, Heart, Zap, Link as LinkIcon, Grid, Settings, Shield, Search } from 'lucide-react';
...
const menuItems = [
    ...
    { label: '設定', href: '/playground/settings-demo', icon: Settings, active: true },
