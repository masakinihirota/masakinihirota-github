...
/*
  NOTE: joinNation was implemented below (duplicate), keep single implementation.
  The duplicate implementation was removed to avoid redeclaration errors.
*/

/* Duplicate leaveNation implementation removed — a single leaveNation implementation remains below. */
      ...
      const eligibility = checkOrganizationEligibility(
        {
          ...
          hasPenalty: false,
          goal: org.description ?? undefined,
        },
        {
